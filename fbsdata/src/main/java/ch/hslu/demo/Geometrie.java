...
/**
 * Klasse mit Geometrie-Funktionen. Stellt verschiedene geometrische Funktionen
 * zur Verfuegung. Derzeit aber nur eine Funktion implementiert.
...
public final class Geometrie {
   ...
   /**
    * Liefert den Quadranten zu einem Koordinatenpaar. Liegen die Koordinaten
    * auf den Achsen oder auf dem Nullpunkt, liefert die Funktion den Wert '0'
    * zurueck.
